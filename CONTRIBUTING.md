...
If you're just looking for quick feedback for an idea or proposal, feel free to open an [issue](https://github.com/homedepot/cf-rolling-restart/issues/new).
...
1. Within your fork of [cf-rolling-restart](https://github.com/homedepot/cf-rolling-restart), create a branch for your contribution and use a meaningful name.
